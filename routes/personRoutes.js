...
const message={
    to:'',
    from:'ishan0553.cse19@chitkara.edu.in',
    subject:'',
    text:'',
    html:'',
}
...
sgMail.setApiKey(process.env.API_KEY);   
   ...
   router.post("/persons", async(req, res) => {
     ...
     message.text=`Dear ${req.body.name}, Welcome to XYZ pvt ltd. You just checked in at ${req.body.inTime} on ${req.body.dateAndDay}. Hope you will enjoy your day here.`;
     message.html=`<h1>Dear ${req.body.name}, Welcome to XYZ pvt ltd. You just entered in the building at ${req.body.inTime} on ${req.body.dateAndDay}. Hope you will enjoy your day here.</h1>`;
